...
const resources = {
  en: {
    translation: {
      ...
      forCommissions: "for new commissions",
      message: "message",
      fullName: "full name",
      send: "send",
      about1:
      "I am an architect and urban designer graduated from Mackenzie Presbyterian University in São Paulo.",
      ...
      language_spanish: "Spanish - intermediate",
  ...
  "pt-BR": {
    translation: {
      ...
      getInTouch: "entre em",
      getInTouchAccent: "contato",
      forCommissions: "para novos projetos",
      message: "mensagem",
      fullName: "nome completo",
      send: "enviar",
      resume: "currículo",
      about1:
        "Sou arquiteta e urbanista formada pela Universidade Presbiteriana Mackenzie, em São Paulo. ",
      about2:
      ...
      language_spanish: "Espanhol - intermediário",
