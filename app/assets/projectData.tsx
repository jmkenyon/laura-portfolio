export const projectData = [
  ...
  },
  {
    title: "percurso",
    slug: "percurso",
    projeto: "acadêmico - u. presbiteriana mackenzie",
    equipe: "individual",
    ano: "2022/1",
    gridSize: 2,
    description: [
  ...
  },
  {
    title: "roissypôle",
    slug: "roissypole",
    projeto: "acadêmico - ensap val-de-seine",
    equipe: "ana julia maciel e laura consoni",
    ano: "2024/1",
    gridSize: 1,
    description: [
      "RoissyPole é um complexo multifuncional no Aeroporto Charles de Gaulle, em Paris, oferecendo uma ampla gama de serviços e conveniências para viajantes e profissionais da aviação. Com hotéis, escritórios, lojas, restaurantes e centros de conferências, o RoissyPole atende milhões de passageiros anualmente, funcionando como um importante centro econômico e logístico. Sua localização estratégica dentro do principal aeroporto da França facilita negócios e parcerias internacionais em um ambiente globalizado.",

      "Além de seus serviços, o RoissyPole é altamente acessível devido à sua integração com o sistema de transporte público de Paris, incluindo trens de alta velocidade (TGV), RER e ônibus, garantindo fácil acesso ao centro da cidade e outras regiões. Essa conectividade melhora a experiência para visitantes e profissionais, fazendo do RoissyPole uma parte vital do Aeroporto Charles de Gaulle e contribuindo para sua posição como um dos principais centros de aviação do mundo.",
