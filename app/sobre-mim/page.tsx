    ...
    <div className="px-8 sm:py-8 py-13 bg-white">
      ...
      <div className="flex sm:flex-row flex-col">
        ...
        <div className="flex flex-col gap-8 py-18 lg:px-20 md:px-16 sm:px-10 justify-start max-w-lg text-sm">
          <h1>[sobre mim]</h1>
        <p>
          Sou uma estudante de arquitetura, atualmente no 8º semestre na Universidade Presbiteriana Mackenzie, em São Paulo. Tenho 22 anos, sou
          natural de Santos (SP) e me mudei para São Paulo em 2020 para cursar a
          faculda- de.
        </p>
        <p>
          ...
          ruínas, orien- tado pelo professor Guilherme Mi- chellin, da FAU
          Mackenzie.
        </p>
        <p>
